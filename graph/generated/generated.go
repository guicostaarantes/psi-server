...
type ComplexityRoot struct {
	...
	Mutation struct {
		...
		AssignTreatment                        func(childComplexity int, id string, priceRange string) int
...
type MutationResolver interface {
	...
	AssignTreatment(ctx context.Context, id string, priceRange string) (*bool, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.assignTreatment":
		...
		return e.complexity.Mutation.AssignTreatment(childComplexity, args["id"].(string), args["priceRange"].(string)), true
...
func (ec *executionContext) _Mutation_assignTreatment(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		directive0 := func(rctx context.Context) (interface{}, error) {
			ctx = rctx // use context from middleware stack in children
			return ec.resolvers.Mutation().AssignTreatment(rctx, args["id"].(string), args["priceRange"].(string))
		}
		directive1 := func(ctx context.Context) (interface{}, error) {
			role, err := ec.unmarshalNRole2ᚕgithubᚗcomᚋguicostaarantesᚋpsiᚑserverᚋmodulesᚋusersᚋmodelsᚐRoleᚄ(ctx, []interface{}{"COORDINATOR", "PSYCHOLOGIST", "PATIENT"})
			if err != nil {
...
func (ec *executionContext) unmarshalInputCreateTreatmentInput(ctx context.Context, obj interface{}) (models1.CreateTreatmentInput, error) {
	...
	for k, v := range asMap {
		...
		case "priceRange":
			...
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("priceRange"))
			it.PriceRange, err = ec.unmarshalNString2string(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) unmarshalInputUpdateTreatmentInput(ctx context.Context, obj interface{}) (models1.UpdateTreatmentInput, error) {
	...
	for k, v := range asMap {
		...
		case "priceRange":
			...
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("priceRange"))
			it.PriceRange, err = ec.unmarshalOString2string(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) _PatientAppointment(ctx context.Context, sel ast.SelectionSet, obj *models2.Appointment) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "priceRange":
			out.Values[i] = ec._PatientAppointment_priceRange(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				atomic.AddUint32(&invalids, 1)
			}
		case "status":
...
func (ec *executionContext) _PatientTreatment(ctx context.Context, sel ast.SelectionSet, obj *models1.GetPatientTreatmentsResponse) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "priceRange":
			out.Values[i] = ec._PatientTreatment_priceRange(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				atomic.AddUint32(&invalids, 1)
			}
		case "status":
...
func (ec *executionContext) _PsychologistAppointment(ctx context.Context, sel ast.SelectionSet, obj *models2.Appointment) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "priceRange":
			out.Values[i] = ec._PsychologistAppointment_priceRange(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				atomic.AddUint32(&invalids, 1)
			}
		case "status":
...
func (ec *executionContext) _PsychologistTreatment(ctx context.Context, sel ast.SelectionSet, obj *models1.GetPsychologistTreatmentsResponse) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "priceRange":
			out.Values[i] = ec._PsychologistTreatment_priceRange(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				atomic.AddUint32(&invalids, 1)
			}
		case "status":
