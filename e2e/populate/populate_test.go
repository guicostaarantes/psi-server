...
func gql(client *http.Client, query string, token string, report *os.File) (*http.Response, error) {
...
func TestPopulateScript(t *testing.T) {
	...
	t.Run("should log in as bootstrap coordinator", func(t *testing.T) {
		...
		response, err := gql(client, query, "", report)
		if err != nil {
			panic(err)
		}
	...
	t.Run("should create jobrunner if not existant", func(t *testing.T) {
		...
		_, err := gql(client, query, storedVariables["coordinator_token"], report)
		if err != nil {
			panic(err)
		}
	...
	t.Run("should create characteristics", func(t *testing.T) {
		...
		response, err := gql(client, query, storedVariables["coordinator_token"], report)
		if err != nil {
			panic(err)
		}
		body, _ := ioutil.ReadAll(response.Body)
		...
		query = `mutation {
			setPsychologistCharacteristics(
				input: [
					{
						name: "gender",
						type: SINGLE,
		...
		query = `mutation {
			setTranslations(
				lang: "pt-BR",
				input: [
					{ key: "pat-char:has-consulted-before", value: "Você já se consultou com um psicólogo alguma vez?" },
					{ key: "pat-char:has-consulted-before:true", value: "Já" },
					{ key: "pat-char:has-consulted-before:false", value: "Nunca" },
					{ key: "pat-char:gender", value: "Com qual desses gêneros você mais se identifica?" },
					...
					{ key: "pat-char:age", value: "Em qual dessas faixas etárias você se encaixa?" },
					...
					{ key: "pat-char:lgbtqiaplus", value: "Você é uma pessoa LBGTQIA+?" },
					{ key: "pat-char:lgbtqiaplus:true", value: "Sim" },
					{ key: "pat-char:lgbtqiaplus:false", value: "Não" },
					{ key: "pat-char:skin-tone", value: "Qual desses tons de pele mais se aproxima ao seu?" },
					...
					{ key: "pat-char:disabilities", value: "Você possui alguma dessas deficiências?" },
					...
					{ key: "pat-char:issues", value: "Marque as opções que te incetivam a procurar tratamento psicológico:" },
					...
					{ key: "pat-pref:has-consulted-before:true", value: "Quão interessado você está em atender pacientes que já fizeram tratamento psicológico anteriormente?" },
					{ key: "pat-pref:has-consulted-before:false", value: "Quão interessado você está em atender pacientes que nunca fizeram tratamento psicológico?" },
					{ key: "pat-pref:gender:female", value: "Quão interessado você está em atender pacientes de gênero feminino?" },
					{ key: "pat-pref:gender:male", value: "Quão interessado você está em atender pacientes de gênero masculino?" },
					{ key: "pat-pref:gender:non-binary", value: "Quão interessado você está em atender pacientes de gênero não binário?" },
					{ key: "pat-pref:age:child", value: "Quão interessado você está em atender pacientes entre 0 e 13 anos?" },
					{ key: "pat-pref:age:teen", value: "Quão interessado você está em atender pacientes entre 14 e 18 anos?" },
					{ key: "pat-pref:age:young-adult", value: "Quão interessado você está em atender pacientes entre 19 e 30 anos?" },
					{ key: "pat-pref:age:adult", value: "Quão interessado você está em atender pacientes entre 31 e 50 anos?" },
					{ key: "pat-pref:age:elderly", value: "Quão interessado você está em atender pacientes com mais de 50 anos?" },
					{ key: "pat-pref:lgbtqiaplus:true", value: "Quão interessado você está em atender pacientes LGBTQIA+?" },
					{ key: "pat-pref:lgbtqiaplus:false", value: "Quão interessado você está em atender pacientes não LGBTQIA+?" },
					{ key: "pat-pref:skin-tone:black", value: "Quão interessado você está em atender pacientes de pele negra?" },
					{ key: "pat-pref:skin-tone:red", value: "Quão interessado você está em atender pacientes de pele vermelha?" },
					{ key: "pat-pref:skin-tone:yellow", value: "Quão interessado você está em atender pacientes de pele amarela?" },
					{ key: "pat-pref:skin-tone:white", value: "Quão interessado você está em atender pacientes de pele branca?" },
					{ key: "pat-pref:disabilities:vision", value: "Quão interessado você está em atender pacientes com deficiência visual?" },
					{ key: "pat-pref:disabilities:hearing", value: "Quão interessado você está em atender pacientes com deficiência auditiva?" },
					{ key: "pat-pref:disabilities:locomotion", value: "Quão interessado você está em atender pacientes com deficiência locomotiva?" },
					...
					{ key: "psy-char:gender", value: "Com qual desses gêneros você mais se identifica?" },
					...
					{ key: "psy-char:lgbtqiaplus", value: "Você é uma pessoa LBGTQIA+?" },
					{ key: "psy-char:lgbtqiaplus:true", value: "Sim" },
					{ key: "psy-char:lgbtqiaplus:false", value: "Não" },
					{ key: "psy-char:skin-tone", value: "Qual desses tons de pele mais se aproxima ao seu?" },
					...
					{ key: "psy-char:sign-language", value: "Você é capaz de atender pacientes utilizando LIBRAS (Linguagem Brasileira de Sinais)?" },
					{ key: "psy-char:sign-language:true", value: "Sim" },
					{ key: "psy-char:sign-language:false", value: "Não" },
					{ key: "psy-char:disabilities", value: "Você possui alguma dessas deficiências?" },
					...
					{ key: "psy-char:methods", value: "Você utiliza quais dessas abordagens da psicologia?" },
					...
					{ key: "psy-pref:gender:male", value: "Quão confortável você se sente sendo atendido por um psicólogo do gênero masculino?" },
					{ key: "psy-pref:gender:female", value: "Quão confortável você se sente sendo atendido por um psicólogo do gênero feminino?" },
					{ key: "psy-pref:gender:non-binary", value: "Quão confortável você se sente sendo atendido por um psicólogo de gênero não binário?" },
					{ key: "psy-pref:lgbtqiaplus:true", value: "Quão confortável você se sente sendo atendido por um psicólogo LGBTQIA+?" },
					{ key: "psy-pref:lgbtqiaplus:false", value: "Quão confortável você se sente sendo atendido por um psicólogo que não é LGBTQIA+?" },
					{ key: "psy-pref:skin-tone:black", value: "Quão confortável você se sente sendo atendido por um psicólogo de pele negra?" },
					{ key: "psy-pref:skin-tone:red", value: "Quão confortável você se sente sendo atendido por um psicólogo de pele vermelha?" },
					{ key: "psy-pref:skin-tone:yellow", value: "Quão confortável você se sente sendo atendido por um psicólogo de pele amarela?" },
					{ key: "psy-pref:skin-tone:white", value: "Quão confortável você se sente sendo atendido por um psicólogo de pele branca?" },
					{ key: "psy-pref:sign-language:true", value: "Quão confortável você se sente sendo atendido por um psicólogo fluente em linguagem de sinais?" },
					{ key: "psy-pref:sign-language:false", value: "Quão confortável você se sente sendo atendido por um psicólogo que não é fluente em linguagem de sinais?" },
					{ key: "psy-pref:disabilities:vision", value: "Quão confortável você se sente sendo atendido por um psicólogo com deficiência visual?" },
					{ key: "psy-pref:disabilities:hearing", value: "Quão confortável você se sente sendo atendido por um psicólogo com deficiência auditiva?" },
					{ key: "psy-pref:disabilities:locomotion", value: "Quão confortável você se sente sendo atendido por um psicólogo com deficiência locomotiva?" },
	...
	t.Run("should create psychologists", func(t *testing.T) {
		...
		for b := 0; b < PSYCHOLOGIST_BATCHES; b++ {
			for i := PSYCOLOGIST_START + b*BATCH_SIZE; i < PSYCOLOGIST_START+(b+1)*BATCH_SIZE; i++ {
				...
				go func(i int) {
					...
					query = fmt.Sprintf(`mutation {
						setMyPsychologistCharacteristicChoices(
							input: [
								{ characteristicName: "gender", selectedValues: [%q] },
								{ characteristicName: "lgbtqiaplus", selectedValues: [%q] },
								{ characteristicName: "skin-tone", selectedValues: [%q] },
								{ characteristicName: "sign-language", selectedValues: [%q] },
								{ characteristicName: "disabilities", selectedValues: [%q] },
								{ characteristicName: "methods", selectedValues: [%q] }
							]
						)
					}`,
						gender,
					...
					query = fmt.Sprintf(`mutation {
						setMyPsychologistPreferences(
							input: [
								{ characteristicName: "has-consulted-before", selectedValue: "true", weight: %d },
								{ characteristicName: "has-consulted-before", selectedValue: "false", weight: %d },
								{ characteristicName: "gender", selectedValue: "female", weight: %d },
								{ characteristicName: "gender", selectedValue: "male", weight: %d },
								{ characteristicName: "gender", selectedValue: "non-binary", weight: %d },
								{ characteristicName: "age", selectedValue: "child", weight: %d },
								{ characteristicName: "age", selectedValue: "teen", weight: %d },
								{ characteristicName: "age", selectedValue: "young-adult", weight: %d },
								{ characteristicName: "age", selectedValue: "adult", weight: %d },
								{ characteristicName: "age", selectedValue: "elderly", weight: %d },
								{ characteristicName: "lgbtqiaplus", selectedValue: "true", weight: %d },
								{ characteristicName: "lgbtqiaplus", selectedValue: "false", weight: %d },
								{ characteristicName: "skin-tone", selectedValue: "black", weight: %d },
								{ characteristicName: "skin-tone", selectedValue: "red", weight: %d },
								{ characteristicName: "skin-tone", selectedValue: "yellow", weight: %d },
								{ characteristicName: "skin-tone", selectedValue: "white", weight: %d },
								{ characteristicName: "disabilities", selectedValue: "vision", weight: %d },
								{ characteristicName: "disabilities", selectedValue: "hearing", weight: %d },
								{ characteristicName: "disabilities", selectedValue: "locomotion", weight: %d },
								{ characteristicName: "issues", selectedValue: "aging", weight: %d },
								{ characteristicName: "issues", selectedValue: "anxiety", weight: %d },
								{ characteristicName: "issues", selectedValue: "autism", weight: %d },
								{ characteristicName: "issues", selectedValue: "body", weight: %d },
								{ characteristicName: "issues", selectedValue: "career", weight: %d },
								{ characteristicName: "issues", selectedValue: "career-choice", weight: %d },
								{ characteristicName: "issues", selectedValue: "compulsion", weight: %d },
								{ characteristicName: "issues", selectedValue: "death-of-keen", weight: %d },
								{ characteristicName: "issues", selectedValue: "depression", weight: %d },
								{ characteristicName: "issues", selectedValue: "desease-in-keen", weight: %d },
								{ characteristicName: "issues", selectedValue: "desease-in-self", weight: %d },
								{ characteristicName: "issues", selectedValue: "discrimination", weight: %d },
								{ characteristicName: "issues", selectedValue: "drug-abuse-keen", weight: %d },
								{ characteristicName: "issues", selectedValue: "drug-abuse-self", weight: %d },
								{ characteristicName: "issues", selectedValue: "existential-crisis", weight: %d },
								{ characteristicName: "issues", selectedValue: "family-conflicts", weight: %d },
								{ characteristicName: "issues", selectedValue: "financial", weight: %d },
								{ characteristicName: "issues", selectedValue: "food-disorder", weight: %d },
								{ characteristicName: "issues", selectedValue: "learning-challenges", weight: %d },
								{ characteristicName: "issues", selectedValue: "memory-loss", weight: %d },
								{ characteristicName: "issues", selectedValue: "mood-control", weight: %d },
								{ characteristicName: "issues", selectedValue: "panic", weight: %d },
								{ characteristicName: "issues", selectedValue: "parenting", weight: %d },
								{ characteristicName: "issues", selectedValue: "partner-abuse", weight: %d },
								{ characteristicName: "issues", selectedValue: "partner-conflicts", weight: %d },
								{ characteristicName: "issues", selectedValue: "physical-pain", weight: %d },
								{ characteristicName: "issues", selectedValue: "post-traumatic-stress", weight: %d },
								{ characteristicName: "issues", selectedValue: "pre-pregnancy", weight: %d },
								{ characteristicName: "issues", selectedValue: "pregnancy", weight: %d },
								{ characteristicName: "issues", selectedValue: "schizophrenia", weight: %d },
								{ characteristicName: "issues", selectedValue: "self-development", weight: %d },
								{ characteristicName: "issues", selectedValue: "self-harm", weight: %d },
								{ characteristicName: "issues", selectedValue: "sexual", weight: %d },
								{ characteristicName: "issues", selectedValue: "sexuality", weight: %d },
								{ characteristicName: "issues", selectedValue: "sleep", weight: %d },
								{ characteristicName: "issues", selectedValue: "social-interactions", weight: %d },
								{ characteristicName: "issues", selectedValue: "stammering", weight: %d },
								{ characteristicName: "issues", selectedValue: "stress", weight: %d },
								{ characteristicName: "issues", selectedValue: "unknown", weight: %d }
							]
						)
					}`,
				...
				go func(i int) {
					...
					query = fmt.Sprintf(`mutation {
						setMyPatientCharacteristicChoices(input: [
							{ characteristicName: "has-consulted-before", selectedValues: [%q] },
							{ characteristicName: "gender", selectedValues: [%q] },
							{ characteristicName: "age", selectedValues: [%q] },
							{ characteristicName: "lgbtqiaplus", selectedValues: [%q] },
							{ characteristicName: "skin-tone", selectedValues: [%q] },
							{ characteristicName: "disabilities", selectedValues: [%q] },
							{ characteristicName: "issues", selectedValues: [%q] },
							{ characteristicName: "income", selectedValues: [%q] }
						])
					}`,
						[]string{"true", "false"}[rand.Intn(2)],
						gender,
					...
					query = fmt.Sprintf(`mutation {
						setMyPatientPreferences(input: [
							...
							{ characteristicName: "skin-tone", selectedValue: "yellow", weight: %d },
							{ characteristicName: "skin-tone", selectedValue: "white", weight: %d },
							{ characteristicName: "sign-language", selectedValue: "true", weight: %d },
							{ characteristicName: "sign-language", selectedValue: "false", weight: %d },
							{ characteristicName: "disabilities", selectedValue: "vision", weight: %d },
							{ characteristicName: "disabilities", selectedValue: "hearing", weight: %d },
							{ characteristicName: "disabilities", selectedValue: "locomotion", weight: %d },
							{ characteristicName: "methods", selectedValue: "psychoanalysis", weight: %d },
							{ characteristicName: "methods", selectedValue: "behaviorism", weight: %d },
							{ characteristicName: "methods", selectedValue: "cognitive", weight: %d },
							{ characteristicName: "methods", selectedValue: "humanistic", weight: %d }
						])
					}`,
						[]int{-1, 0, 1, 3}[rand.Intn(4)],
						[]int{-1, 0, 1, 3}[rand.Intn(4)],
	...
	t.Run("should assign treatments", func(t *testing.T) {
		...
		totalElapsed := float64(time.Since(totalStart).Milliseconds()) / 1000.0
		report.WriteString(fmt.Sprintf("Total time elapsed: %.3f seconds\n", totalElapsed))
